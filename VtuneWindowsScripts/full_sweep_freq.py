...
# full fprate benchmarks: 503, 507, 508, 510, 511, 519, 521, 538, 544, 549, 554, 997
# full intspeed benchmarks: +100


BENCHES = [500]
FREQUENCIES = [1000, 1100, 1200, 1300, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2300, 2400, 2500, 2600, 3700]
CACHE_WAYS = [11]
RUNS_PER_FREQ = 5
    ...
    for bench in BENCHES:
        for freq in FREQUENCIES:
            for ways in CACHE_WAYS:
                ...
                try:
                    if(SSH):
                        ssh_command(f"~/scripts/set_freq_cache.sh --freq {freq} --cache {ways}")
                    else:
                        #TODO: set freq cache local
                        pass
